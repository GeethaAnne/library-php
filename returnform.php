...
<div class="navigation">
	...
	<div class="main">		
		...
		<div class="content">
			...
			<div class="node">
			<div class="menu">
	<class="but">|<a href="listofborrowers_1.php">List of Borrowers</a>|
	<br>
	<br>
<hr width="600">
...
<hr width="600">
<table cellspacing="6">
<form class="form" action="checkouts.php" method="POST">
    <tr>
	...
	<td><button name="returnbook"><a class="-buttonform" ><span class="-home">Go</span></a></button></td>
        <td></td>
    </tr>
</form>
</table>
